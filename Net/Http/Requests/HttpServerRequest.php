...
namespace Tale\Net\Http\Requests;

use Tale\Net\Http\HttpRequest,
	Tale\Net\Http\HttpBodyInterface,
	Tale\System\StringUtils,
	Tale\Net\Http\HttpMethod,
	Tale\Net\Url,
	Tale\Net\Ip\IpEndPoint,
	Tale\Net\Ip\IpAddress,
	Tale\Net\Mime\MimeType,
	Tale\Net\Http\Responses\HttpServerResponse;
...
class HttpServerRequest extends HttpRequest {
	...
	public function getAddress() {
		...
		return IpAddress::fromString( $this->getArg( 'serverAddr' ) );
	}

	public function getEndPoint() {

		return new IpEndPoint( $this->getAddress(), $this->getArg( 'serverPort' ) );
	}

	public function getRemoteAddress() {

		return IpAddress::fromString( $this->getArg( 'remoteAddr' ) );
	}

	public function getRemoteEndPoint() {

		return new IpEndPoint( $this->getRemoteAddress(), $this->getArg( 'remotePort' ) );
	}

	public function createResponse() {

		$res = new HttpServerResponse();
