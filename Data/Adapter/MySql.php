...
class MySql extends PdoAdapterBase {
	...
	public function __construct( array $options = null ) {
		parent::__construct( array_replace_recursive( [
			...
			'engine' => 'InnoDB',
			'inflections' => [
				'databases' => 'Tale\\StringUtils::tableize',
				'tables' => 'Tale\\StringUtils::tableize',
				'columns' => 'Tale\\StringUtils::tableize',
				'inputColumns' => 'Tale\\StringUtils::tableize',
				'outputColumns' => 'Tale\\StringUtils::variablize'
			]
		], $options ? $options : [] ) );
