...
class DomSelector {
    ...
    static $_availablePseudos = [
        'first-child' => [ 'Tale\\Dom\\DomSelectorPseudo', 'isFirstChild' ],
        'last-child' => [ 'Tale\\Dom\\DomSelectorPseudo', 'isLastChild' ],
        'nth-child' => [ 'Tale\\Dom\\DomSelectorPseudo', 'isNthChild' ],
        'not' => [ 'Tale\\Dom\\DomSelectorPseudo', 'isNot' ],
        'even' => [ 'Tale\\Dom\\DomSelectorPseudo', 'isEven' ],
        'odd' => [ 'Tale\\Dom\\DomSelectorPseudo', 'isOdd' ]
    ];
    ...
    public static function isValid( $selectorString ) {
        ...
        return preg_match( self::REGEX, $selectorString );
    }

    public static function fromString( $selectorString ) {

        $matches = [];
        $success = preg_match_all( self::REGEX, $selectorString, $matches );
